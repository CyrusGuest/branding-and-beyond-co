    ...
    <div className="relative md:hidden px-4">
      ...
      <div className="flex flex-col gap-4 text-xl">
        ...
        <div className="grid grid-cols-2 grid-rows-3 text-base font-bold gap-y-3">
          <MobileService title="Website design" />

          <MobileService title="Website development" />

          <MobileService title="SEO Optimization" />

          <MobileService title="Brand management" />

          <MobileService title="Analytics & Reporting" />

          <MobileService title="24/7 Support" />
        </div>
