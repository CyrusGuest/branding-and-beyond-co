...
const Explore = () => {
  return (
    <div className="pt-20 pl-3 pb-20 md:hidden">
      ...
      <Link to="/packages">
        <button className="text-2xl mobile-btn mt-8 text-white gradient-background glow-on-hover bg-white dark:hover:bg-brand-primary dark:hover:text-brand-secondary hover:bg-brand-primary hover:text-white">
          view more packages
        </button>
      </Link>
