...
const Explore = () => {
  return (
    <div className='bg-brand-primary pt-20 pl-3 pb-20 md:hidden'>
      ...
      <button className='text-2xl mobile-btn mt-8 text-brand-primary dark:text-brand-primary dark:bg-brand-secondary bg-white dark:hover:bg-brand-primary dark:hover:text-brand-secondary hover:bg-brand-primary hover:text-white'>view more deals</button>
