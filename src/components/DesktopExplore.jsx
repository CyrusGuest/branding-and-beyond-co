  ...
  return (
    <div className='hidden md:flex bg-brand-primary py-20 pl-6'>
      <div className='my-auto max-w-3xl w-2/5 mx-auto'>
        ...
        <Link to="/packages"><button className='text-2xl mobile-btn mt-8 text-brand-primary dark:bg-brand-secondary bg-white dark:hover:bg-brand-primary dark:hover:text-brand-secondary hover:bg-brand-primary hover:text-white'>view more packages</button></Link>
      </div>
