  ...
  return (
    <div>
      ...
      <div className='flex justify-center mt-10 space-x-6'>
        <button className='text-2xl mobile-btn text-white dark:text-brand-secondary dark:hover:bg-brand-secondary dark:hover:text-brand-primary bg-brand-primary hover:bg-white hover:text-brand-primary'>learn more</button>
        <button className='text-2xl mobile-btn dark:text-brand-primary dark:bg-brand-secondary dark:hover:bg-brand-primary dark:hover:text-brand-secondary text-brand-primary  bg-white hover:bg-brand-primary hover:text-white'>contact us</button>
      </div>
