    ...
    <div className='font-Poppins w-4/5 max-w-4xl bg-brand-primary rounded-lg mx-auto mt-20 mb-40 drop-shadow-lg hidden md:flex'>
      ...
      <div className='bg-white p-8 rounded-r-lg dark:bg-brand-secondary'>
        ...
        <div className='flex justify-center mt-4 gap-6'>
          <Link to="/packages"><button className='text-lg mobile-btn dark:text-brand-secondary text-white bg-brand-primary dark:hover:bg-brand-secondary dark:hover:text-brand-primary hover:bg-white hover:text-brand-primary'>our packages</button></Link>
          <Link to="/contactus"><button className='text-lg mobile-btn dark:bg-brand-secondary dark:hover:bg-brand-primary dark:hover:text-brand-secondary text-brand-primary bg-white hover:bg-brand-primary hover:text-white'>contact us</button></Link>
        </div>
